...
$con_category_latest_show = $con_layout['category_latest_show'];
$con_category_ad_post_show = $con_ads['category_ad_post_show'];
$con_category_ad_post = $con_ads['category_ad_post']; 
?>

<?php get_header(); // show header ?>

<?php con_get_category(); ?>    

<?php if($con_category_ad_post_show) { ?>
    <div class="full-width-ad">    
        <?php echo $con_category_ad_post; // ad ?>        
    </div>
<?php } ?>

<?php if($con_category_latest_show) { // show The Latest panel ?>
	<?php con_get_latest(); ?>
<?php } ?>
