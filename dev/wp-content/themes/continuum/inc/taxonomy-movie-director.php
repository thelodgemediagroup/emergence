...
$current_term = get_term_by( 'slug', $wp_query->query_vars['movie_director'], 'movie_director' );
$headertext=$current_term->name.__(' Movie Reviews:','continuum');
?>
...
<div id="feed-wrapper" class="category">
    ...
    <div id="feed">
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Newest movie reviews in all genres', 'continuum' ); ?>" class="<?php if($feedsort=='' || $feedsort=='date') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('date') ?>"><?php _e( 'Recent', 'continuum' ); ?></a>
        
        </div>
        
        <div class="sort">
        
            <a title="<?php _e( 'Highest rated movies in all genres', 'continuum' ); ?>" class="<?php if($feedsort=='meta_value') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('meta_value') ?>"><?php _e( 'Highest Rated', 'continuum' ); ?></a>
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Randomize all movie reviews', 'continuum' ); ?>" class="<?php if($feedsort=='rand') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('rand') ?>"><?php _e( 'Random', 'continuum' ); ?></a>
        ...
        <?php } elseif ($con_review_layout=="B") { ?>
            ...
            <div class="right-panel sidebar"> <!-- begin right sidebar -->
                ...
                <div class="inner">
                	...
                	<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Sidebar Product Reviews') ) : else : ?>
            ...
            <div class="feed-vertical-wrapper">
                            ...
                            <div class="feed-vertical">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="article">
                                        ...
                                        <a class="read-more" href="<?php the_permalink(); ?>"><b><?php _e( 'Full Review &raquo;', 'continuum' ); ?></b></a>
                ...
                <div class="right-panel sidebar alt"> <!-- begin right sidebar -->
                    ...
                    <div class="inner">
						...
						<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Sidebar Movie Reviews') ) : else : ?>
