...
$current_term = get_term_by( 'slug', $wp_query->query_vars['music_artist'], 'music_artist' );
$headertext=$current_term->name.__(' Music Reviews:','continuum');
?>
...
<div id="feed-wrapper" class="category">
    ...
    <div id="feed">
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Newest music reviews in all genres', 'continuum' ); ?>" class="<?php if($feedsort=='' || $feedsort=='date') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('date') ?>"><?php _e( 'Recent', 'continuum' ); ?></a>
        
        </div>
        
        <div class="sort">
        
            <a title="<?php _e( 'Highest rated music in all genres', 'continuum' ); ?>" class="<?php if($feedsort=='meta_value') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('meta_value') ?>"><?php _e( 'Highest Rated', 'continuum' ); ?></a>
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Randomize all music reviews', 'continuum' ); ?>" class="<?php if($feedsort=='rand') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('rand') ?>"><?php _e( 'Random', 'continuum' ); ?></a>
        ...
        <?php } elseif ($con_review_layout=="B") { ?>
            ...
            <div class="right-panel sidebar"> <!-- begin right sidebar -->
                ...
                <div class="inner">
                	...
                	<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Sidebar Music Reviews') ) : else : ?>
