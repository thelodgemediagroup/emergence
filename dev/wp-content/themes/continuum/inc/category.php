...
$con_category_layout = $con_layout['category_layout'];
$con_category_header = $con_layout['category_header'];
$con_category_num = $con_layout['category_num'];
$con_category_ad_num = $con_ads['category_ad_num'];
$con_category_ads_increment = $con_ads['category_ads_increment'];
$con_category_ads_offset = $con_ads['category_ads_offset'];
$con_category_ad_1 = $con_ads['category_ad_1'];
$con_category_ad_2 = $con_ads['category_ad_2'];
$con_category_ad_3 = $con_ads['category_ad_3'];
$con_category_ad_4 = $con_ads['category_ad_4'];
$con_category_ad_5 = $con_ads['category_ad_5'];
$con_category_ad_6 = $con_ads['category_ad_6'];
$con_category_ad_7 = $con_ads['category_ad_7'];
$con_category_ad_8 = $con_ads['category_ad_8'];
$con_category_ad_9 = $con_ads['category_ad_9'];
$con_category_ad_10 = $con_ads['category_ad_10'];
$con_category_unique_sidebar = $con_layout['category_unique_sidebar'];
...
<?php // user specified a unique category sidebar
if ($con_category_unique_sidebar) {
	$con_category_unique_sidebar="Sidebar Category";
} else {
	$con_category_unique_sidebar="Sidebar Default";
}
?>
...
if($con_category_single && $feedsort=="") {
	$feedsort = "related";
}
?>
...
<?php // setup the query
global $query_string;
$args=$query_string . '&posts_per_page='.$con_category_num.'&paged='.$paged.'&order=DESC&orderby='.$feedsort; 
?>

<?php $category_loop = new WP_Query($args); ?>
...
<div id="feed-wrapper" class="category">
    ...
    <div id="feed-panel-wrapper">
        ...
        <?php $ads = array( //grab all 10 ads regardless of how many should be displayed on home page
                         ...
                         8 => $con_category_ad_8,
                         9 => $con_category_ad_9,
                         10 => $con_category_ad_10
                         );	 ?>
                         
        <?php if($con_category_layout=="A") { ?>
        
            <?php $postcount=0; ?>
            
            <?php $adcount=0; ?>
            
            <?php if ($category_loop->have_posts()) : while ($category_loop->have_posts()) : $category_loop->the_post(); $postcount++; ?>
                ...
                <?php if($con_category_ad_num!=0) { // display ads in the feed ?>			
                
                    <?php if($postcount==$con_category_ads_offset+1) { // the first ad to display ?>
                    ...
                    <?php } elseif ((($postcount-$con_category_ads_offset-1) % ($con_category_ads_increment)==0) && ($postcount>$con_category_ads_offset) && ($con_category_ad_num>$adcount)) { // incremented ads ?>
            ...
            <?php // pagination
			pagination($category_loop->max_num_pages);
			?>  
            
            <br class="clearer" /><br />
        
        <?php } elseif ($con_category_layout=="B") { ?>
            ...
            <div class="left-panel"> <!-- begin left panel -->
                ...
                <?php if ($category_loop->have_posts()) : while ($category_loop->have_posts()) : $category_loop->the_post(); $postcount++; ?>
                    ...
                    <?php if($con_category_ad_num!=0) { // display ads in the feed ?>	
                        ...
                        <?php } elseif ((($postcount-$con_category_ads_offset) % ($con_category_ads_increment+1)==0) && ($postcount>$con_category_ads_offset) && ($con_category_ad_num>$adcount)) { // incremented ads ?>
            ...
            <div class="right-panel sidebar"> <!-- begin right sidebar -->
                ...
                <div class="inner">
                    ...
                    <?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar($con_category_unique_sidebar) ) : else : ?>
        ...
        <?php } elseif ($con_category_layout=="C") { ?>
