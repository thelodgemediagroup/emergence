...
<?php 
// setup the query
$args='&posts_per_page='.$con_review_num.'&post_type=con_product_reviews&paged='.$paged.'&order=DESC&orderby='.$feedsort.'&meta_key=Rating';
?>
...
<div id="feed-wrapper" class="category">
    ...
    <div id="feed">
        ...
        <div class="header gentesque">
            ...
            <?php _e( 'Product Reviews:', 'continuum' ); ?>
        
        </div>
        
        <div class="sort">
        
            <a title="<?php _e( 'Newest product reviews in all categories', 'continuum' ); ?>" class="<?php if($feedsort=='' || $feedsort=='date') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('date') ?>"><?php _e( 'Recent', 'continuum' ); ?></a>
        
        </div>
        
        <div class="sort">
        
            <a title="<?php _e( 'Highest rated products in all categories', 'continuum' ); ?>" class="<?php if($feedsort=='meta_value') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('meta_value') ?>"><?php _e( 'Highest Rated', 'continuum' ); ?></a>
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Randomize all product reviews', 'continuum' ); ?>" class="<?php if($feedsort=='rand') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('rand') ?>"><?php _e( 'Random', 'continuum' ); ?></a>
