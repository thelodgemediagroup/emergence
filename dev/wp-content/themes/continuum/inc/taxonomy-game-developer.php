...
$current_term = get_term_by( 'slug', $wp_query->query_vars['game_developer'], 'game_developer' );
$headertext=$current_term->name.__(' Game Reviews:','continuum');
?>
...
<div id="feed-wrapper" class="category">
    ...
    <div id="feed">
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Newest game reviews in all genres', 'continuum' ); ?>" class="<?php if($feedsort=='' || $feedsort=='date') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('date') ?>"><?php _e( 'Recent', 'continuum' ); ?></a>
        
        </div>
        
        <div class="sort">
        
            <a title="<?php _e( 'Highest rated games in all genres', 'continuum' ); ?>" class="<?php if($feedsort=='meta_value') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('meta_value') ?>"><?php _e( 'Highest Rated', 'continuum' ); ?></a>
        ...
        <div class="sort">
            ...
            <a title="<?php _e( 'Randomize all game reviews', 'continuum' ); ?>" class="<?php if($feedsort=='rand') { ?>current <?php } ?>tooltip" href="<?php con_get_feed_link('rand') ?>"><?php _e( 'Random', 'continuum' ); ?></a>
