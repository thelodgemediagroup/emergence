...
<?php // setup the query
$args='&posts_per_page='.$con_review_num.'&post_type=con_game_reviews&paged='.$paged.'&order=DESC&orderby='.$feedsort.'&meta_key=Rating';
?>
...
<div id="feed-wrapper" class="category">
    ...
    <div id="feed">
        ...
        <div class="header gentesque">
            ...
            <?php _e( 'Video Game Reviews:', 'continuum' ); ?>
