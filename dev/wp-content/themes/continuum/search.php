...
$con_search_latest_show = $con_layout['search_latest_show'];
$con_search_ad_post_show = $con_ads['search_ad_post_show'];
$con_search_ad_post = $con_ads['search_ad_post']; 
?>
...
<?php if($con_search_ad_post_show) { ?>
    <div class="full-width-ad">    
        <?php echo $con_search_ad_post; // ad ?>        
    </div>
<?php } ?>

<?php if($con_search_latest_show) { // show The Latest panel ?>
	<?php con_get_latest(); ?>
<?php } ?>
