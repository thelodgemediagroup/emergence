...
$con_review_movies_positive_text = $con_reviews['review_movies_positive_text'];
$con_review_movies_negative_text = $con_reviews['review_movies_negative_text'];
            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                ...
                <div class="reviewbox-wrapper">
                    ...
                    <div class="reviewbox">
                        ...
                        <h2 class="gentesque"><?php _e( 'Movie Overview', 'continuum' ); ?></h2>
                        ...
                        <?php $cat_list = get_the_term_list( $post->ID, 'movie_genre', __('Genre: ','continuum'), ', ', '' ); ?>
                        ...
                        <?php if($positives) { ?>
                        	...
                        	<div><div class="pros"><?php echo $con_review_movies_positive_text; ?>:</div>&nbsp;<?php echo $positives; ?></div>
                        ...
                        <?php if($negatives) { ?>
                            ...
                            <div><div class="cons"><?php echo $con_review_movies_negative_text; ?>:</div>&nbsp;<?php echo $negatives; ?></div>
                            
                            <br class="clearer" />
                            
                        <?php } ?>
                        
                        <div><div class="bottom-line"><?php echo $con_review_movies_bottomline_text; ?>:</div>&nbsp;<?php echo $ratings[0]; ?> / 5 - <?php echo $ratings[2]; ?></div>
